...
DASH_ST_LSM303DLHX_ENABLE = true
endif
...
SENSORS_COMPASS_AK897XNA=true
DASH_SENSORS += wrappers/ak897xna_sensors.c
DASH_SENSORS_CFLAGS += -DAK8972
DASH_SENSORS_CFLAGS += -DAKM_CHIP_NAME=\"AK8972\"
DASH_SENSORS_CFLAGS += -DAKM_CHIP_MAXRANGE=4900
DASH_SENSORS_CFLAGS += -DAKM_CHIP_RESOLUTION=60
DASH_SENSORS_CFLAGS += -DAKM_CHIP_POWER=0.4
LOCAL_STATIC_LIBRARIES := SEMC_8972 libAK8972
endif
...
DASH_SENSORS_CFLAGS += -DAKM_CHIP_RESOLUTION=100
...
ifeq ($(SENSORS_COMPASS_AK897XNA),true)
DASH_SENSORS += ak897xna.c
endif
...
# Gyro sensors
#
ifeq ($(SENSORS_GYRO_MPU3050),true)
